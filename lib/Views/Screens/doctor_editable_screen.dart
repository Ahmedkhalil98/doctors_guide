...
class DoctorEditableScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(
          () {
            return editableController.isLoading.value
                ? const LoadingWidget()
                : FutureBuilder<QuerySnapshot<Map<String, dynamic>>>(
                    future: showDoctorInfo.doctorDetails(int.parse(
                              ...
                              child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    textFieldTitle(
                                        subTitle: "قم برفع صورتك الشخصية :"),
                                    Container(
                                      height: 50.h,
                                      margin:
                                    ...
                                    MyTextFieldWidget(
                                      ...
                                      hint:
                                          "اسم منطقة,اسم شارع,اسم مشفى او مجمع",
                                      title: "أدخل العنوان العيادة :",
                                    ),
                                    textFieldTitle(
                                        subTitle:
                                            "قم بتحديد موقع العيادة على الخريطة:"),
                                    Container(
                                        margin: EdgeInsets.symmetric(
                                        ...
                                        child: GetBuilder<Editable>(
                                          ...
                                          if (editableController.kGooglePlex ==
                                              null) {
                                            return const Center(
                                                child:
